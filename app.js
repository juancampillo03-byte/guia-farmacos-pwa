document.addEventListener('DOMContentLoaded', () => {
    ...
    btnVO.onclick = () => navegarA(`
        ...
        <p style="font-size:0.85em; color:gray; text-align:center; margin-bottom:15px;">Presentaciones parenterales de fármacos que pueden adminsitrarse por vía oral (bebibles)</p>
